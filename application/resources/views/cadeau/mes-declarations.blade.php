...
@section('title') Mes Déclarations @endsection
...
@section('body')
    ...
    @section('content')
        ...
        <div class="home-btn d-none d-sm-block">
            ...
            <a href="#" class="px-2 text-primary" data-toggle="tooltip" data-placement="top" title="Mes Declarations">
                    ...
                    <div class="col-md-10 col-lg-10 col-xl-10">
                        <div class="card overflow-hidden">
                            <div class="text-center mt-2">
                                <h3 style="color: #9c182f">Mes Déclarations</h3>
