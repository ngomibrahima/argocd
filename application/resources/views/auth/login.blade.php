                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-5">
                                <div class="p-2">
                                    <form method="POST" action="{{route('auth.login')}}" onsubmit="disableButton()">
                                        @csrf
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-block waves-effect waves-light" style="background-color: #9c182f; color: white" type="submit" id="submit">Se Connecter</button>
                                        </div>
